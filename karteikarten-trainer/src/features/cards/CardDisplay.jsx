import { LEVELS, normalizeCardText, normalizeLevel } from "../../lib/storage.js";

// Renders card text with a small markdown subset: "- item" bullet lists and
// **bold** inline spans. Used for both the flashcard faces and the
// collection list previews.
